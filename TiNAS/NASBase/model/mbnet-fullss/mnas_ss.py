...
# ====================================== IMAGE 100 ==========================================================================
# ==========================================================================================================================
EXP_FACTORS_IMAGE100 = [1, 3, 4, 6]
KERNEL_SIZES_IMAGE100 = [1, 3, 5, 7]
MOBILENET_NUM_LAYERS_EXPLICIT_IMAGE100 = [1, 2, 3]
SUPPORT_SKIP_IMAGE100 = [False, True] 
    
WIDTH_MULTIPLIER_IMAGE100 = [0.25, 0.5, 0.75, 1.0]
INPUT_RESOLUTION_IMAGE100 = [32, 64, 96, 128]
    
MOBILENET_V2_NUM_OUT_CHANNELS_IMAGE100 = [16, 24, 32, 64, 96, 160, 320]
